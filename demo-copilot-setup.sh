...
echo "   - name: Setup dev environment"
echo "     uses: ./.github/actions/setup-dev-env"
echo ""
echo "   For minimal setup:"
echo "   - name: Setup minimal environment"
echo "     uses: ./.github/actions/setup-dev-env"
echo "     with:"
echo "       skip-playwright: 'true'"
echo "       skip-virtual-display: 'true'"
echo ""
